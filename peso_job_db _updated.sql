...
CREATE TABLE `employers` (
  ...
  `number_of_employees` enum('1-10','11-50','51-100','101-500','500+') DEFAULT NULL,
  `completed_registration` tinyint(1) NOT NULL DEFAULT 0
...
--
ALTER TABLE `employers`
  MODIFY `employer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
