...
<?php endif; ?>
            ...
            <?= form_open('/employer/job_postings', ['method' => 'post']) ?>

          <div class="form-group">
            <?= form_label('Title', 'title', ['class' => 'form-label']) ?>
            <?= form_input('title', set_value('title'), ['id' => 'title', 'class' => 'form-control', 'placeholder' => 'Enter job title']) ?>
          </div>
          <div class="form-group">
            <?= form_label('Description', 'description', ['class' => 'form-label']) ?>
            <?= form_textarea('description', set_value('description'), ['id' => 'description', 'class' => 'form-control', 'rows' => 3, 'placeholder' => 'Enter job description']) ?>
          </div>
          <div class="form-group">
            <?= form_label('Requirements', 'requirements', ['class' => 'form-label']) ?>
            <?= form_textarea('requirements', set_value('requirements'), ['id' => 'requirements', 'class' => 'form-control', 'rows' => 3, 'placeholder' => 'Enter job requirements']) ?>
          </div>
          <div class="form-group row">
            <div class="col-md-6">
              <?= form_label('Salary', 'salary', ['class' => 'form-label']) ?>
              <?= form_input('salary', set_value('salary'), ['id' => 'salary', 'class' => 'form-control', 'placeholder' => 'Enter job salary']) ?>
            </div>
            <div class="col-md-6">
              <?= form_label('Location', 'location', ['class' => 'form-label']) ?>
              <?= form_input('location', set_value('location'), ['id' => 'location', 'class' => 'form-control', 'placeholder' => 'Enter job location']) ?>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-6">
